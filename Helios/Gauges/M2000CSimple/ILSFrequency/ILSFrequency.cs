...
namespace GadrocsWorkshop.Helios.Gauges.M2000CSimple.ILSFrequencey
{
    ...
    [HeliosControl("Helios.M2000CSimple.ILSFrequency", "ILS Frequency", "M2000CSimple Gauges", typeof(GaugeRenderer))]
    public class ILSFrequency : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{Helios}/Gauges/M2000CSimple/ILSFrequency/ils_frequency_faceplate.xaml", new Rect(0d, 0d, 300d, 100d)));

            _megaHzDrum = new GaugeDrumCounter("{Helios}/Gauges/M2000CSimple/Common/drum_tape.xaml", new Point(13.5d, 11.5d), "###", new Size(10d, 15d), new Size(50d, 75d));
            _megaHzDrum.Clip = new RectangleGeometry(new Rect(13.5d, 11.5d, 150d, 75d));
            Components.Add(_megaHzDrum);

            _kiloHzDrum = new GaugeDrumCounter("{Helios}/Gauges/M2000CSimple/Common/drum_tape.xaml", new Point(183.5, 11.5d), "#%", new Size(10d, 15d), new Size(50d, 75d));
