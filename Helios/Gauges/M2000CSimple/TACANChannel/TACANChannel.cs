...
namespace GadrocsWorkshop.Helios.Gauges.M2000CSimple.TACANChannel
{
    ...
    [HeliosControl("Helios.M2000CSimple.TACANChannel", "TACAN Channel", "M2000CSimple Gauges", typeof(GaugeRenderer))]
    public class TACANChannel : BaseGauge
    {
        ...
        {
            Components.Add(new GaugeImage("{Helios}/Gauges/M2000CSimple/TACANChannel/tacan_channel_faceplate.xaml", new Rect(0d, 0d, 243d, 100d)));

            _tensDrum = new GaugeDrumCounter("{Helios}/Gauges/M2000CSimple/TACANChannel/tacan_channel_hundreds_tape.xaml", new Point(84d, 11.5d), "##", new Size(10d, 15d), new Size(50d, 75d));
            _tensDrum.Clip = new RectangleGeometry(new Rect(84d, 11.5d, 100d, 75d));
            Components.Add(_tensDrum);

            _onesDrum = new GaugeDrumCounter("{Helios}/Gauges/M2000CSimple/Common/drum_tape.xaml", new Point(177d, 11.5d), "#", new Size(10d, 15d), new Size(50d, 75d));
            _onesDrum.Clip = new RectangleGeometry(new Rect(177d, 11.5d, 50d, 75d));
            Components.Add(_onesDrum);

            _xModeImage = new GaugeImage("{Helios}/Gauges/M2000CSimple/TACANChannel/tacan_channel_x_mode.xaml", new Rect(20d, 20d, 44d, 59d));
            Components.Add(_xModeImage);

            _yModeImage = new GaugeImage("{Helios}/Gauges/M2000CSimple/TACANChannel/tacan_channel_y_mode.xaml", new Rect(20d, 20d, 44d, 59d));
