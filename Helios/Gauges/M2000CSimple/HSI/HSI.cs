...
namespace GadrocsWorkshop.Helios.Gauges.M2000CSimple.HSI
{
    ...
    [HeliosControl("Helios.M2000CSimple.HSI", "HSI", "M2000CSimple Gauges", typeof(GaugeRenderer))]
    public class HSI : BaseGauge
    {
        ...
        private GaugeImage _compassImage;
        ...
        public HSI()
            : base("HSI", new Size(360, 360))
        {
            Point center = new Point(180, 180);

            //            Components.Add(new GaugeRectangle(Colors.Black, new Rect(10, 10, 330, 330)));
            _compassNeedle = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_compass.xaml", new Point(210, 210), new Size(360, 360), new Point(210, 210));
            Components.Add(_compassNeedle);
            //            Components.Add(new GaugeImage("{Helios}/Gauges/M2000CSimple/Common/eng_needle.xaml", new Rect(0d, 0d, 360d, 360d)));

            _milesDrum = new GaugeDrumCounter("{Helios}/Gauges/M2000CSimple/Common/drum_tape.xaml", new Point(140, 100), "0000", new Size(10d, 15d), new Size(30d, 45d));
            _milesDrum.Clip = new RectangleGeometry(new Rect(140d, 68d, 120d, 45d));
            Components.Add(_milesDrum);

            /*            _courseDrum = new GaugeDrumCounter("{Helios}/Gauges/M2000CSimple/Common/drum_tape.xaml", new Point(282, 68), "##%", new Size(10d, 15d), new Size(13d, 18d));
                        _courseDrum.Clip = new RectangleGeometry(new Rect(282d, 68d, 39d, 18d));
                        Components.Add(_courseDrum);

                        _dmeFlagImage = new GaugeImage("{Helios}/Gauges/M2000CSimple/HSI/hsi_range_flag.xaml", new Rect(27, 74, 37, 10));
                        _dmeFlagImage.IsHidden = true;
                        Components.Add(_dmeFlagImage);

                        _courseFlagNeedle = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_bearing_flag.xaml", center, new Size(350, 350), center);
                        _courseFlagNeedle.IsHidden = true;
                        Components.Add(_courseFlagNeedle);

                        _toFlagNeedle = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_to_flag.xaml", center, new Size(350, 350), center);
                        _toFlagNeedle.IsHidden = true;
                        Components.Add(_toFlagNeedle);

                        _fromFlagNeedle = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_from_flag.xaml", center, new Size(350, 350), center);
                        _fromFlagNeedle.IsHidden = true;
                        Components.Add(_fromFlagNeedle);

                        _deviationCard = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_deviation_card.xaml", center, new Size(183, 183), new Point(91.5, 91.5));
                        Components.Add(_deviationCard);

                        _deviationNeedle = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_deviation_needle.xaml", center, new Size(6, 149), new Point(3, 74.5));
                        Components.Add(_deviationNeedle);
                        
            _desiredCourseNeedle = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_course_needle.xaml", center, new Size(16, 217), new Point(8, 108.5));
            Components.Add(_desiredCourseNeedle);
            
            Components.Add(new GaugeImage("{Helios}/Gauges/M2000CSimple/HSI/hsi_faceplate.xaml", new Rect(0, 0, 350, 350)));

            _headingBug = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_heading_bug.xaml", center, new Size(22, 9), new Point(11, 130.5));
            Components.Add(_headingBug);
            */
            _bearingNeedle = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_bearing_needle_1.xaml", center, new Size(9, 288), new Point(4.5, 148));
            Components.Add(_bearingNeedle);
            /*
            _bearingNeedle2 = new GaugeNeedle("{Helios}/Gauges/M2000CSimple/HSI/hsi_bearing_needle_2.xaml", center, new Size(12, 267), new Point(6, 133.5));
            Components.Add(_bearingNeedle2);

            _offFlagImage = new GaugeImage("{Helios}/Gauges/M2000CSimple/HSI/hsi_off_flag.xaml", new Rect(266, 116, 77, 131));
            _offFlagImage.IsHidden = true;
            Components.Add(_offFlagImage);

            Components.Add(new GaugeImage("{Helios}/Gauges/M2000CSimple/HSI/hsi_bezel.png", new Rect(0, 0, 350, 350)));*/
