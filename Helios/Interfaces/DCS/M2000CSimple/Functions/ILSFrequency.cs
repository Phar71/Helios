...
namespace GadrocsWorkshop.Helios.Interfaces.DCS.M2000CSimple.Functions
{
    ...
    {
        private static DCSDataElement[] _dataElements = new DCSDataElement[] { new DCSDataElement("617", "%0.1f", false), new DCSDataElement("618", "%0.1f", false) };

        private double _mhz = 108;
        private double _khz = .30;
        ...
        {
            _frequency = new HeliosValue(sourceInterface, BindingValue.Empty, "VOR/ILS", "Frequency", "Currently tuned ILS frequency.", "", BindingValueUnits.Numeric);
